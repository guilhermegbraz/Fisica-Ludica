...
fun Container.backgroundView(gameMap: GameLevel, backgroundImageBitmap: Bitmap, width: Double, height: Double) = BackgroundView(gameMap, backgroundImageBitmap, width, height).addTo(this)
class BackgroundView(gameMap: GameLevel, backgroundImageBitmap: Bitmap, width: Double, height: Double): Container() {
